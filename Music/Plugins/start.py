...
def start_pannel():
    buttons = [
        ...
        [
            InlineKeyboardButton("🌐 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 🌐", url="https://github.com/zezanx26"),
        ],
    ]
    return (
...
pstart_markup = InlineKeyboardMarkup(
    [
        ...
        [
            InlineKeyboardButton("🌐 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 🌐", url="https://github.com/eldy020502"),
        ],
    ]
)
...
⏳ **Durasi:** {round(x["duration"] / 350)} Mins
